...
set firewall name lan-local default-log
...
set firewall name local-services default-log

# From LOCAL to WAN
set firewall name local-wan description 'From LOCAL to WAN'
set firewall name local-wan default-action 'accept'
set firewall name local-wan default-log
...
set firewall name services-lan default-log
...
set firewall name wan-lan default-log

# From WAN to LOCAL
set firewall name wan-local description 'From WAN to LOCAL'
set firewall name wan-local default-action 'drop'
set firewall name wan-local default-log
...
set firewall name wan-services default-log
