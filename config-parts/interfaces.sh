...
# set interfaces bonding bond0 vif 10 address '10.10.0.1/24'
# set interfaces bonding bond0 vif 11 description 'HOMELAB'
# set interfaces bonding bond0 vif 11 address '10.11.0.1/24'
# set interfaces bonding bond0 vif 12 description 'STAGING'
# set interfaces bonding bond0 vif 12 address '10.12.0.1/24'
# set interfaces bonding bond0 vif 20 description 'TRUSTED'
# set interfaces bonding bond0 vif 20 address '10.20.0.1/24'
...
set interfaces ethernet eth0 vif 11 description 'HOMELAB'
set interfaces ethernet eth0 vif 11 address '10.11.0.1/24'
set interfaces ethernet eth0 vif 12 description 'STAGING'
set interfaces ethernet eth0 vif 12 address '10.12.0.1/24'
