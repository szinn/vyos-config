...
set firewall name servers-local rule 7 description 'Rule: prometheus_metrics'
set firewall name servers-local rule 7 action 'accept'
set firewall name servers-local rule 7 destination group port-group prometheus-metrics
