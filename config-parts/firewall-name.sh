...
set firewall name local-trusted rule 400 description 'Rule: accept_discovery_from_sonos_controllers'
set firewall name local-trusted rule 400 action 'accept'
set firewall name local-trusted rule 400 destination port '1900,1901,1902,57621'
set firewall name local-trusted rule 400 protocol 'udp'
set firewall name local-trusted rule 400 source group address-group 'sonos-controllers'
...
set firewall name trusted-local rule 400 description 'Rule: accept_discovery_from_sonos_controllers'
set firewall name trusted-local rule 400 action 'accept'
set firewall name trusted-local rule 400 source group address-group 'sonos-controllers'
set firewall name trusted-local rule 400 destination port '1900,1901,1902,57621'
set firewall name trusted-local rule 400 protocol 'udp'
set firewall name trusted-local rule 410 description 'Rule: accept_discovery_from_sonos_players'
set firewall name trusted-local rule 410 action 'accept'
set firewall name trusted-local rule 410 source group address-group 'sonos-players'
set firewall name trusted-local rule 410 destination port '1900,1901,1902'
set firewall name trusted-local rule 410 protocol 'udp'
...
set firewall name trusted-guest rule 420 description 'Rule: accept_udp_from_sonos_players_to_sonos_controllers'
set firewall name trusted-guest rule 420 action 'accept'
set firewall name trusted-guest rule 420 source group address-group 'sonos-players'
set firewall name trusted-guest rule 420 destination group address-group 'sonos-controllers'
set firewall name trusted-guest rule 420 destination port '319,320,30000-65535'
set firewall name trusted-guest rule 420 protocol 'udp'
set firewall name trusted-guest rule 421 description 'Rule: accept_tcp_from_sonos_players_to_sonos_controllers'
set firewall name trusted-guest rule 421 action 'accept'
set firewall name trusted-guest rule 421 source group address-group 'sonos-players'
set firewall name trusted-guest rule 421 destination group address-group 'sonos-controllers'
set firewall name trusted-guest rule 421 destination port '1400,3400,3401,3500,30000-65535'
set firewall name trusted-guest rule 421 protocol 'tcp'
...
set firewall name guest-local rule 400 description 'Rule: accept_discovery_from_sonos_controllers'
set firewall name guest-local rule 400 action 'accept'
set firewall name guest-local rule 400 source group address-group 'sonos-controllers'
set firewall name guest-local rule 400 destination port '1900,1901,1902,57621'
set firewall name guest-local rule 400 protocol 'udp'
set firewall name guest-local rule 410 description 'Rule: accept_discovery_from_sonos_players'
set firewall name guest-local rule 410 action 'accept'
set firewall name guest-local rule 410 source group address-group 'sonos-players'
set firewall name guest-local rule 410 destination port '1900,1901,1902'
set firewall name guest-local rule 410 protocol 'udp'
...
set firewall name guest-trusted rule 430 description 'Rule: accept_tcp_from_sonos_controllers_to_sonos_players'
set firewall name guest-trusted rule 430 action 'accept'
set firewall name guest-trusted rule 430 source group address-group 'sonos-controllers'
set firewall name guest-trusted rule 430 destination group address-group 'sonos-players'
set firewall name guest-trusted rule 430 destination port '1400,1443,4444,7000,30000-65535'
set firewall name guest-trusted rule 430 protocol 'tcp'
set firewall name guest-trusted rule 431 description 'Rule: accept_udp_from_sonos_controllers_to_sonos_players'
set firewall name guest-trusted rule 431 action 'accept'
set firewall name guest-trusted rule 431 source group address-group 'sonos-controllers'
set firewall name guest-trusted rule 431 destination group address-group 'sonos-players'
set firewall name guest-trusted rule 431 destination port '319,320,30000-65535'
set firewall name guest-trusted rule 431 protocol 'udp'
