...
# set firewall name lan-local rule 11 destination port 'ssh'
# set firewall name lan-local rule 11 protocol 'tcp'
# set firewall name lan-local rule 14 description 'Rule: accept mdns'
# set firewall name lan-local rule 14 action 'accept'
# set firewall name lan-local rule 14 destination port 'mdns'
# set firewall name lan-local rule 14 protocol 'udp'
# set firewall name lan-local rule 14 source port 'mdns'
...
set firewall name local-servers rule 2 description 'Rule: accept dns'
...
set firewall name local-servers rule 10 description 'Rule: accept_syslog'
set firewall name local-servers rule 10 action 'accept'
set firewall name local-servers rule 10 destination port '6003'
...
set firewall name local-trusted rule 11 description 'Rule: accept mdns'
set firewall name local-trusted rule 11 action 'accept'
set firewall name local-trusted rule 11 destination port 'mdns'
set firewall name local-trusted rule 11 protocol 'udp'
set firewall name local-trusted rule 11 source port 'mdns'
...
set firewall name local-iot rule 11 description 'Rule: accept igmp'
set firewall name local-iot rule 11 action 'accept'
set firewall name local-iot rule 11 protocol '2'
set firewall name local-iot rule 12 description 'Rule: accept mdns'
set firewall name local-iot rule 12 action 'accept'
set firewall name local-iot rule 12 destination port 'mdns'
set firewall name local-iot rule 12 protocol 'udp'
set firewall name local-iot rule 12 source port 'mdns'
...
set firewall name services-local rule 3 description 'Rule: accept ntp'
set firewall name services-local rule 3 action 'accept'
set firewall name services-local rule 3 destination port 'ntp'
set firewall name services-local rule 3 protocol 'udp'
set firewall name services-local rule 4 description 'Rule: accept dhcp'
set firewall name services-local rule 4 action 'accept'
set firewall name services-local rule 4 destination port 'bootps,bootpc'
set firewall name services-local rule 4 protocol 'udp'
set firewall name services-local rule 4 source port 'bootps,bootpc'
...
set firewall name services-iot rule 11 description 'Rule: accept icmp'
set firewall name services-iot rule 11 action 'accept'
set firewall name services-iot rule 11 protocol 'icmp'
...
set firewall name servers-lan rule 11 description 'Rule: accept icmp'
set firewall name servers-lan rule 11 action 'accept'
set firewall name servers-lan rule 11 protocol 'icmp'
...
set firewall name servers-local rule 15 description 'Rule: accept tftp'
set firewall name servers-local rule 15 action 'accept'
set firewall name servers-local rule 15 destination port '69'
set firewall name servers-local rule 15 protocol 'udp'
set firewall name servers-local rule 16 description 'Rule: accept ssh'
set firewall name servers-local rule 16 action 'accept'
set firewall name servers-local rule 16 destination port 'ssh'
set firewall name servers-local rule 16 protocol 'tcp'
set firewall name servers-local rule 17 description 'Rule: accept prometheus metrics'
set firewall name servers-local rule 17 action 'accept'
set firewall name servers-local rule 17 destination group port-group prometheus-metrics
set firewall name servers-local rule 17 protocol 'tcp'
...
# set firewall name trusted-local rule 12 description 'Rule: accept ssh'
# set firewall name trusted-local rule 12 action 'accept'
# set firewall name trusted-local rule 12 destination port 'ssh'
# set firewall name trusted-local rule 12 protocol 'tcp'
# set firewall name trusted-local rule 15 description 'Rule: accept igmp'
# set firewall name trusted-local rule 15 action 'accept'
# set firewall name trusted-local rule 15 protocol '2'
# set firewall name trusted-local rule 16 description 'Rule: accept mdns'
# set firewall name trusted-local rule 16 action 'accept'
# set firewall name trusted-local rule 16 destination port 'mdns'
# set firewall name trusted-local rule 16 protocol 'udp'
# set firewall name trusted-local rule 16 source port 'mdns'
...
set firewall name iot-local rule 3 description 'Rule: accept ntp'
...
set firewall name iot-local rule 4 description 'Rule: accept dhcp'
set firewall name iot-local rule 4 action 'accept'
set firewall name iot-local rule 4 destination port 'bootps,bootpc'
set firewall name iot-local rule 4 protocol 'udp'
set firewall name iot-local rule 4 source port 'bootps,bootpc'
set firewall name iot-local rule 13 description 'Rule: accept igmp'
set firewall name iot-local rule 13 action 'accept'
set firewall name iot-local rule 13 protocol '2'
set firewall name iot-local rule 14 action 'accept'
set firewall name iot-local rule 14 description 'Rule: accept mdns'
set firewall name iot-local rule 14 destination port 'mdns'
set firewall name iot-local rule 14 protocol 'udp'
set firewall name iot-local rule 14 source port 'mdns'
...
set firewall name iot-servers rule 11 description 'Rule: accept_plex_iot_users'
set firewall name iot-servers rule 11 action 'accept'
set firewall name iot-servers rule 11 source group address-group 'iot-plex-users'
set firewall name iot-servers rule 11 destination group address-group 'plex-server'
set firewall name iot-servers rule 11 destination port '32400'
...
set firewall name wan-local rule 11 description 'Rule: accept_wireguard'
set firewall name wan-local rule 11 action 'accept'
set firewall name wan-local rule 11 destination port '51820'
...
set firewall name wan-servers rule 11 description 'Rule: accept_ingress_from_cloudflare'
set firewall name wan-servers rule 11 action 'accept'
set firewall name wan-servers rule 11 destination group address-group 'k8s_main_ingress'
set firewall name wan-servers rule 11 destination port 'https'
set firewall name wan-servers rule 11 protocol 'tcp'
set firewall name wan-servers rule 11 source group network-group 'cloudflare-networks-ipv4'
