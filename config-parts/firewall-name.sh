...
set firewall name servers-local rule 8 description 'Rule: accept_nodeexporter'
set firewall name servers-local rule 8 action 'accept'
set firewall name servers-local rule 8 destination port '9100'
set firewall name servers-local rule 8 protocol 'tcp'
set firewall name servers-local rule 9 description 'Rule: accept_nodeexporter'
set firewall name servers-local rule 9 action 'accept'
set firewall name servers-local rule 9 destination port '9342'
set firewall name servers-local rule 9 protocol 'tcp'
set firewall name servers-local rule 10 description 'Rule: accept_nodeexporter'
