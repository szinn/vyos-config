...
set firewall name local-trusted rule 13 description 'Rule: accept_discovery_from_sonos_controllers'
set firewall name local-trusted rule 13 action 'accept'
set firewall name local-trusted rule 13 destination port '1900,1901,1902,57621'
set firewall name local-trusted rule 13 protocol 'udp'
set firewall name local-trusted rule 13 source group address-group 'sonos-controllers'
...
set firewall name local-iot rule 3 description 'Rule: accept icmp'
set firewall name local-iot rule 3 action 'accept'
set firewall name local-iot rule 3 protocol 'icmp'
...
set firewall name local-guest rule 12 description 'Rule: accept_discovery_from_sonos_players'
set firewall name local-guest rule 12 action 'accept'
set firewall name local-guest rule 12 source group address-group 'sonos-players'
set firewall name local-guest rule 12 destination port '1900,1901,1902'
set firewall name local-guest rule 12 protocol 'udp'
...
set firewall name trusted-local rule 12 description 'Rule: accept_discovery_from_sonos_players'
set firewall name trusted-local rule 12 action 'accept'
set firewall name trusted-local rule 12 source group address-group 'sonos-players'
set firewall name trusted-local rule 12 destination port '1900,1901,1902'
set firewall name trusted-local rule 12 protocol 'udp'
set firewall name trusted-local rule 13 description 'Rule: accept_discovery_from_sonos_controllers'
set firewall name trusted-local rule 13 action 'accept'
set firewall name trusted-local rule 13 source group address-group 'sonos-controllers'
set firewall name trusted-local rule 13 destination port '1900,1901,1902,57621'
set firewall name trusted-local rule 13 protocol 'udp'
...
set firewall name trusted-guest rule 100 description 'Rule: accept_udp_from_sonos_players_to_sonos_controllers'
set firewall name trusted-guest rule 100 action 'accept'
set firewall name trusted-guest rule 100 source group address-group 'sonos-players'
set firewall name trusted-guest rule 100 destination group address-group 'sonos-controllers'
set firewall name trusted-guest rule 100 destination port '319,320,30000-65535'
set firewall name trusted-guest rule 100 protocol 'udp'
set firewall name trusted-guest rule 110 description 'Rule: accept_tcp_from_sonos_players_to_sonos_controllers'
set firewall name trusted-guest rule 110 action 'accept'
set firewall name trusted-guest rule 110 source group address-group 'sonos-players'
set firewall name trusted-guest rule 110 destination group address-group 'sonos-controllers'
set firewall name trusted-guest rule 110 destination port '1400,3400,3401,3500,30000-65535'
set firewall name trusted-guest rule 110 protocol 'tcp'
...
set firewall name guest-local rule 6 description 'Rule: accept igmp'
set firewall name guest-local rule 6 action 'accept'
set firewall name guest-local rule 6 protocol '2'
set firewall name guest-local rule 12 description 'Rule: accept_discovery_from_sonos_players'
set firewall name guest-local rule 12 action 'accept'
set firewall name guest-local rule 12 source group address-group 'sonos-players'
set firewall name guest-local rule 12 destination port '1900,1901,1902'
set firewall name guest-local rule 12 protocol 'udp'
set firewall name guest-local rule 13 description 'Rule: accept_discovery_from_sonos_controllers'
set firewall name guest-local rule 13 action 'accept'
set firewall name guest-local rule 13 source group address-group 'sonos-controllers'
set firewall name guest-local rule 13 destination port '1900,1901,1902,57621'
set firewall name guest-local rule 13 protocol 'udp'
...
set firewall name guest-trusted rule 110 description 'Rule: accept_tcp_from_sonos_controllers_to_sonos_players'
set firewall name guest-trusted rule 110 action 'accept'
set firewall name guest-trusted rule 110 source group address-group 'sonos-controllers'
set firewall name guest-trusted rule 110 destination group address-group 'sonos-players'
set firewall name guest-trusted rule 110 destination port '1400,1443,4444,7000,30000-65535'
set firewall name guest-trusted rule 110 protocol 'tcp'
set firewall name guest-trusted rule 120 description 'Rule: accept_udp_from_sonos_controllers_to_sonos_players'
set firewall name guest-trusted rule 120 action 'accept'
set firewall name guest-trusted rule 120 source group address-group 'sonos-controllers'
set firewall name guest-trusted rule 120 destination group address-group 'sonos-players'
set firewall name guest-trusted rule 120 destination port '319,320,30000-65535'
set firewall name guest-trusted rule 120 protocol 'udp'
