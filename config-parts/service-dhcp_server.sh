...
set service dhcp-server shared-network-name TRUSTED subnet 10.20.0.0/24 static-mapping scotte-odin-win11 ip-address '10.20.0.28'
...
set service dhcp-server shared-network-name TRUSTED subnet 10.20.0.0/24 static-mapping scotte-usbc-1 ip-address '10.20.0.29'
set service dhcp-server shared-network-name TRUSTED subnet 10.20.0.0/24 static-mapping scotte-usbc-1 mac-address '00:e0:4c:a9:19:4a'
