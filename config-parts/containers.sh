...
set container name gatus image 'ghcr.io/twin/gatus:v5.5.0'
...
set container name main-k8s-api image 'docker.io/library/haproxy:2.8.1'
...
set container name staging-k8s-api image 'docker.io/library/haproxy:2.8.1'
