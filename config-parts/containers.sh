...
set container name udp-broadcast-relay-mdns environment CFG_DEV value 'eth0.20;eth0.98'
...
set container name cloudflare-ddns environment DOMAINS value 'zinn.ca,zinn.tech,vpn.zinn.tech,ingress.zinn.ca'
