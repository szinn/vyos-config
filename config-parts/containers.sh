...
set container name dnsdist environment TZ value 'America/Toronto'
...
set container name gatus image 'ghcr.io/twin/gatus:v5.10.0'
...
set container name pihole image 'ghcr.io/szinn/pihole-unbound:2024.03.2'
...
set container name main-k8s-api image 'docker.io/library/haproxy:2.9.7'
...
set container name staging-k8s-api image 'docker.io/library/haproxy:2.9.7'
