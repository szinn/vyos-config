...
set firewall name staging-local rule 350 description 'Rule: accept prometheus metrics scrape'
set firewall name staging-local rule 350 action 'accept'
set firewall name staging-local rule 350 destination group port-group prometheus-metrics
set firewall name staging-local rule 350 protocol 'tcp'
