...
set nat destination rule 200 inbound-interface name 'bond0.10'
...
set nat destination rule 201 inbound-interface name 'bond0.20'
...
set nat destination rule 202 inbound-interface name 'bond0.10'
...
set nat destination rule 203 inbound-interface name 'bond0.98'
...
set nat destination rule 204 inbound-interface name 'bond0.99'
...
set nat destination rule 205 inbound-interface name 'bond0.11'
...
set nat destination rule 206 inbound-interface name 'bond0.12'
